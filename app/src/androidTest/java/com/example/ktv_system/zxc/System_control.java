...
public class System_control {
    ...
    public void weidiange(){
        ViewInteraction bottomNavigationItemView = onView(Matchers.allOf(ViewMatchers.withId(R.id.control_item), withContentDescription("遥控"),
                childAtPosition(childAtPosition(withId(R.id.bootomnav2), 0), 1), isDisplayed()));
        bottomNavigationItemView.perform(click());
        new Handler(Looper.getMainLooper()).postDelayed(() -> {Espresso.onView(withText("未点歌"))
    ...
    public void kongzhi() {
        ...
        ViewInteraction bottomNavigationItemView2 = onView(allOf(withId(R.id.music_item), withContentDescription("点歌"),
        ...
        ViewInteraction textView = onView(allOf(withId(R.id.diange_listview_geming), withText("style"),
